            ...
            try:
                ...
                if isinstance(mock_value, dict):
                    ...
                    if callable(mock_value) and not isinstance(mock_value, type):
                        ...
                        patcher = patch(full_path, side_effect=mock_value, create=needs_create)
                    else:
...
def auto_analyze(func: Callable = None, *, 
                detect_patterns: Optional[List[str]] = None,
                override_preset: Optional[str] = None,
                enable_auto_mocks: bool = True) -> Callable:
    """
    ...
    def decorator(test_func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            if detect_patterns:
                analysis['patterns'] = {p for p in analysis['patterns'] if p in detect_patterns}
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            if preset_name != recommended and preset_name != 'custom':
                print(f"⚠️  AST Analysis: Function {func.__name__} would benefit from '{recommended}' preset instead of '{preset_name}'")
...
PRESET_CONFIGS = {
    ...
    "file_operations": {
        ...
        "builtins": {
            "open": lambda f, mode='r': StringIO("mock file content")
        }
    },
    ...
    "file_system": {
        ...
        "builtins": {
            "open": lambda f, mode='r': StringIO("test file content")
        }
    }
}
...
TEMPLATE_CONFIGS = {
    ...
    "file_processor": {
        ...
        "builtins": {
            "open": lambda f, mode='r': StringIO("${file_content}")
        }
    }
}
